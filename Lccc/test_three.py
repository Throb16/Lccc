...
def main(args):
    ...
    with torch.no_grad():
        for ind, (imgA, imgB, seg_label, token_all, token_all_len, _, _, name) in enumerate(
            ...
            feat1, feat2 = Suppression_module(feat1, feat2)  # 抑制模块
            feat1, feat2, = Complementary_module(feat1, feat2)  # 互补模块
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_folder', default='./LEVIR-MCI-dataset/images',
    ...
    parser.add_argument('--checkpoint', default='/home/ps/data/data-1/zym/Code/Change-Agent/Multi_change/models_ckpt/baseline_2025-08-13-05-36-52_train_goal_2_91/baseline_2025-08-13-05-36-52_train_goal_2_91/LEVIR_MCI_bts_16_segformer-mit_b1_epo_69_Sum_151520_MIou_84724_Bleu4_66889.pth', help='path to checkpoint')
